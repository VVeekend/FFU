	...
	NDefines_Graphics.NGraphics.PROVINCE_BORDER_FADE_NEAR = 800
	...
	NDefines_Graphics.NGraphics.UNITS_DISTANCE_CUTOFF = 220
	
	NDefines_Graphics.NGraphics.WEATHER_DISTANCE_CUTOFF = 10500 -- At what distance weather effects are hidden
	NDefines_Graphics.NGraphics.WEATHER_ZOOM_IN_CUTOFF = 1 -- At what distance weather effects are faded out the most when zooming in
